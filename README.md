...
```bash
# Build from source
git clone https://github.com/meganwall/dbvalidator
cd dbvalidator
go build -o dbvalidator ./cmd/dbvalidator

# Or install directly
go install github.com/meganwall/dbvalidator/cmd/dbvalidator@latest
```
...
[![CI](https://github.com/meganwall/dbvalidator/actions/workflows/ci.yml/badge.svg)](https://github.com/meganwall/dbvalidator/actions/workflows/ci.yml)
